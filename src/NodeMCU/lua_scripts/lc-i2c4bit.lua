...
return function(bus_args)
   ...
   local rs = bus_args.rs or 12
   local rw = bus_args.rw or 255
   local en = bus_args.en or 11
   local bl = bus_args.backlight or 3
   local d4 = bus_args.d4 or 5
   local d5 = bus_args.d5 or 4
   local d6 = bus_args.d6 or 3
   local d7 = bus_args.d7 or 2
